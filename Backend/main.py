...
class DesktopApi:
    """
    Diese Klasse wird über pywebview dem Frontend zur Verfügung gestellt.

    JavaScript kann später z. B. aufrufen:
        window.pywebview.api.save_ppt_file(...)
    """
    ...
    def save_ppt_file(
        self,
        file_url: str,
        suggested_filename: str = "Aktualisierte_Praesentation.pptx"
    ):
        """
